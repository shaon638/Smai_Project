...
def train(model,num_epochs,train_loader,val_loader,optimizer,criterion, model_name = "ResNet_152_tiny", model_path = "teacher_model",loss_path= "teacher_model_loss", device = "cuda"):
	train_loss = {}
	val_loss =  {}
	dur = []
