...
def train(model,num_epochs,train_loader,val_loader,optimizer,criterion, model_name = "RegNet_y_8gf_tiny", model_path = "teacher_model",loss_path= "teacher_model_loss", device = "cuda"):
	train_loss = {}
	val_loss =  {}
	dur = []
...
teacher_model = models.regnet_y_8gf(pretrained = True)
# print(teacher_model)
