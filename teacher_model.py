...
def train(model,num_epochs,train_loader,val_loader,optimizer,criterion, model_name = "ResNet152_ImageNet_tiny", model_path = "teacher_model",loss_path= "teacher_model_loss", device = "cuda"):
	train_loss = {}
	val_loss =  {}
	dur = []
	...
	for epoch in range(num_epochs):
		...
		for batch_index, (data, target) in enumerate(train_loader):
  			...
  			out_loss += loss.item()
  			print(f"BatchLoss: {batch_index+1}\t loss {loss.item()}",flush = True)
