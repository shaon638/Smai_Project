...
def train(model,num_epochs,train_loader,val_loader,optimizer,criterion, model_name = "VIT_cifar100", model_path = "/ssd_scratch/cvit/shaon/teacher_model",loss_path= "loss", device = "cuda"):
	train_loss = {}
	val_loss =  {}
	dur = []
