...
def train(model,num_epochs,train_loader,val_loader,optimizer,criterion, model_name = "vgg16_cifar100", model_path = "/ssd_scratch/cvit/shaon/teacher_model",loss_path= "loss", device = "cuda"):
	train_loss = {}
	val_loss =  {}
	dur = []
	...
	for epoch in range(num_epochs):
		...
		with open(loss_path + "/val_loss"+"_"+model_name+"_"+str(epoch+1)+".pkl","wb")as file:
			dump(val_loss, file)
		# with open(loss_path+ "/info_about_model"+"_"+model_name+"_"+str(epoch +1)+".txt","wb")as file1:
		# 	for line in lines:
		# 		file1.write(line)
...
teacher_model.fc = nn.Linear(4096, 100)
