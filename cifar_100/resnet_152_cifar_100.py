...
def train(model,num_epochs,train_loader,val_loader,optimizer,criterion, model_name = "ResNet152v2_cifar100", model_path = "/ssd_scratch/cvit/shaon/teacher_model_resnet152_cifar100",loss_path= "loss_2", device = "cuda"):
	train_loss = {}
	val_loss =  {}
	dur = []
