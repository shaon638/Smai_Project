...
def train(model,num_epochs,train_loader,val_loader,optimizer,criterion, model_name = "ResNet18_cifar100", model_path = "/ssd_scratch/cvit/shaon/teacher_model_resnet18_without_aug",loss_path= "loss_2", device = "cuda"):
	train_loss = {}
	val_loss =  {}
	dur = []
