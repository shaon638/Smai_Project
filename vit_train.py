...
def train(model,num_epochs,train_loader,val_loader,optimizer,criterion, model_name = "VIT_ImageNet_tiny", model_path = "/ssd_scratch/cvit/shaon/teacher_model",loss_path= "teacher_model_loss", device = "cuda"):
	train_loss = {}
	val_loss = {}
	dur = []
...
# print(v)
# total_params = sum(
# 	param.numel() for param in v.parameters()
# )
# print(total_params)
